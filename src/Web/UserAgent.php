...
final class UserAgent
{
    ...
    private function generateChromeUserAgent()
    {
    ...
    private function generateFirefoxUserAgent()
    {
    ...
    private function generateExplorerUserAgent()
    {
    ...
    private function generateMobileUserAgent()
    {
